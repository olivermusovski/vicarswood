...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Product::create([
        	...
        	'BaseNBR' => 601,
        	'ProdName' => [
        		'en' => '3-Drawer Pine Chest',
        		'es' => 'Cofre de pino de 3 gavetas'
        	],
        	'ProdDesc' => [
        		'en' => 'Gerrans Chest',
        		'es' => 'Cofre de Walsham'
        	...
        	'ProdProse' => [
        		'en' => 'This chest of drawers made of pine and poplar.  With a recipe of dye and glaze, its finish shows off a Regency style suitable for either bedroom or office.  Solid wood surrounds three drawers to endure through ages.  All wood is cut, shaped and fitted within a small Las Vegas workshop.  The result bears the Vicarswood emblem distinguishes it for any furniture collection.
				...
				'es' => 'Esta cómoda hecha de pino y álamo. Muestra el estilo Regency adecuado para dormitorio u oficina. La madera maciza rodea tres cajones para soportar a través de las edades. Toda la madera se corta, se forma y se monta dentro de un pequeño taller de Las Vegas. El resultado lleva el emblema de Vicarswood lo distingue para cualquier colección de muebles.
			...
			'UpdatedBy' => 1,
			'CaptionDim' => [
				'en' => 'Dimensions (Inches, Width x Length x Height)',
				'es' => 'Dimensiones (Pulgadas, ancho x largo x alto)'
			],
			'CaptionPrice' => [
				'en' => 'Price (varies with options selected)',
				'es' => 'Precio (varia según las opciones seleccionadas)'
			],
			'LeadTime' => 10,
        ...
        Product::create([
        	...
        	'BaseNBR' => 605,
        	'ProdName' => [
        		'en' => 'Pine File Cabinet',
        		'es' => 'Cofre de pino de 3 gavetas'
        	],
        	'ProdDesc' => [
        		'en' => 'Tregony File Cabinet',
        		'es' => 'Cofre de Walsham'
        	],
        	'ProdProse' => [
        		'en' => 'This chest of drawers is a spin from the Walsham Chest.  Where it was wide; now it is narrow and finds its position in smaller quarters.
